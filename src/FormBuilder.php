...
class FormBuilder
{
	...
	protected function prepare($fields, BaseAttribute $attribute)
	{
	...
	public function forAttributes(AttributeCollection $attributes)
	{
		...
		$attributes->each(function (BaseAttribute $attribute) use (&$form) {
	...
	/**
	 * @param \Stylemix\Base\Attributes\BaseAttribute $attribute
	 *
